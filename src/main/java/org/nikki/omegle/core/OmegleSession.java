...
public class OmegleSession {
    ...
    public void send(final String text) throws OmegleException {
        ...
        try {
            ...
            if (!resp.equals("win")) {
                throw new OmegleException("Unable to send message, response: " + resp);
            }
    ...
    public void typing() throws OmegleException {
        try {
            ...
            if (!resp.equals("win")) {
                throw new OmegleException("Unable to set state to typing, response: " + resp);
            }
            typing = !typing;
        } catch (IOException e) {
            throw new OmegleException(e);
    ...
    private void fireEvent(OmegleEvent event, Object obj) {
        try {
            ...
            case spyMessage:
                ...
                break;
            case spyTyping:
                OmegleSpyStranger typingStranger = OmegleSpyStranger
                        .valueOf(((JSONArray) obj).getString(1).replace(" ", "_"));
            ...
            case spyStoppedTyping:
                OmegleSpyStranger sTypingStranger = OmegleSpyStranger
                        .valueOf(((JSONArray) obj).getString(1).replace(" ", "_"));
            ...
            case spyDisconnected:
                OmegleSpyStranger disconnectedStranger = OmegleSpyStranger
                        .valueOf(((JSONArray) obj).getString(1).replace(" ", "_"));
    ...
    public void disconnect() throws OmegleException {
        try {
            String resp = HttpUtil.post(Omegle.DISCONNECT_URL, "id=" + encodedId);
            if (!resp.equals("win")) {
                throw new OmegleException("Unable to disconnect, response: " + resp);
            }
            fireEvent(OmegleEvent.disconnected, null);
            omegle.removeSession(this);
        } catch (IOException e) {
